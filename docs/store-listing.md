# Ficha de Play Console — Apexly

## Nombre de la app
Apexly

## Descripción corta (máx. 80 caracteres)
Un circuito nuevo cada día. Traza la línea ideal y bate a tus amigos.
...
Un circuito. Un día. Un mejor tiempo por descubrir.

---

## Categoría
Juegos → Carreras (Racing)

## Etiquetas / público objetivo
- Clasificación de contenido: a determinar en el cuestionario IARC (sin
  violencia real, sin contenido sexual; incluye anuncios y compras).
- No dirigida específicamente a niños (por los anuncios de terceros).

## Email de contacto
yeissyapps@gmail.com

## URL de la política de privacidad
https://yeissyapps.github.io/apexly/privacy-policy.html

## Sitio web (opcional)
— (pendiente si se compra dominio apexly.com)

## Capturas de pantalla
Ver `docs/screenshots/` (generadas desde el dispositivo real).

## Feature graphic (1024×500)
Pendiente — depende del logo final.
